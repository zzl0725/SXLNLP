...
class DialogSystem:
    ...
    def nlg(self, memory):
        ...
        if memory["action"] == "answer":
            ...
            replay_intent.append(memory["bot_response"])
        ...
        memory["replay_intent"] = replay_intent
        return memory
